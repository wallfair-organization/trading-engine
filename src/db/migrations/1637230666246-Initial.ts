...
export class Initial1637230666246 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user_account" ("user_id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "owner_account" character varying NOT NULL, "account_namespace" character varying NOT NULL, "symbol" character varying NOT NULL, CONSTRAINT "PK_1e7af5387f4169347ddef6e8180" PRIMARY KEY ("user_id"))`);
        await queryRunner.query(`CREATE TABLE "account" ("owner_account" character varying NOT NULL, "account_namespace" character varying NOT NULL, "symbol" character varying NOT NULL, "balance" numeric NOT NULL, CONSTRAINT "PK_8ec3dedb1ee17a8630a7c57b0f9" PRIMARY KEY ("owner_account", "account_namespace", "symbol"))`);
        await queryRunner.query(`CREATE TABLE "transaction_queue" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "network_code" character varying NOT NULL, "receiver" character varying NOT NULL, "sender" character varying, "namespace" character varying NOT NULL, "symbol" character varying NOT NULL, "amount" numeric NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "externalTransactionId" uuid, CONSTRAINT "REL_2e04dde8bf8c8e75df059196cb" UNIQUE ("externalTransactionId"), CONSTRAINT "CHK_a5f9a226d8b603dd5b1cb29665" CHECK ("amount" >= 0), CONSTRAINT "PK_ab1d574dc95be0e4aa761888c54" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_2803aa8bc828ab88576a5df7b5" ON "transaction_queue" ("receiver") `);
        await queryRunner.query(`CREATE INDEX "IDX_c287130be8a5b64a6c45620eb0" ON "transaction_queue" ("sender") `);
        await queryRunner.query(`CREATE INDEX "IDX_055c605d41833e6324cf47d8ab" ON "transaction_queue" ("namespace") `);
        await queryRunner.query(`CREATE INDEX "IDX_148f84d2196835249130725fde" ON "transaction_queue" ("symbol") `);
        ...
        await queryRunner.query(`ALTER TABLE "transaction_queue" ADD CONSTRAINT "FK_2e04dde8bf8c8e75df059196cb8" FOREIGN KEY ("externalTransactionId") REFERENCES "external_transaction"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "transaction_queue" DROP CONSTRAINT "FK_2e04dde8bf8c8e75df059196cb8"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_148f84d2196835249130725fde"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_055c605d41833e6324cf47d8ab"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_c287130be8a5b64a6c45620eb0"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2803aa8bc828ab88576a5df7b5"`);
