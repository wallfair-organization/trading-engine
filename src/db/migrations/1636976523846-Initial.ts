...
export class Initial1636976523846 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "external_transaction" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "originator" character varying NOT NULL, "external_system" character varying NOT NULL, "status" character varying NOT NULL, "external_transaction_id" character varying, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_169d396061ffd3ef349913de2c6" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
